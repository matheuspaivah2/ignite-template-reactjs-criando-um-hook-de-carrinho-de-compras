...
const Cart = (): JSX.Element => {
  ...
  function handleProductIncrement(product: Product) {
    updateProductAmount(product.id, product.amount, "increment");
  }

  function handleProductDecrement(product: Product) {
    updateProductAmount(product.id, product.amount, "decrement");
  }
          ...
          {cart.map((product) => (
            <tr data-testid="product" key={product.id}>
              ...
              <td>
                ...
                <span>{cartFormatted[cart.indexOf(product)].price}</span>
              </td>
              <td>
                <div>
                  <button
                  ...
                  <button
                    ...
                    disabled={product.amount >= stock[product.id - 1]?.amount}
